...
const MAP: Record<string, Entry> = {
  ...
  "arrow.up": { lib: "ion", name: "arrow-up" },
  "arrow.up.right": { lib: "mci", name: "arrow-top-right" },
  ellipsis: { lib: "ion", name: "ellipsis-horizontal" },
  ...
  "pause.fill": { lib: "ion", name: "pause" },
  "play.fill": { lib: "ion", name: "play" },
  "stop.circle": { lib: "ion", name: "stop-circle-outline" },
  "bolt.horizontal.circle": { lib: "ion", name: "flash-outline" },
  ...
  "clock.badge.xmark": { lib: "mci", name: "clock-alert-outline" },
  ...
  "person.2": { lib: "mci", name: "account-multiple" },
  "wallet.pass": { lib: "mci", name: "wallet" },
  "arrow.up.arrow.down": { lib: "ion", name: "swap-vertical" },
  gift: { lib: "ion", name: "gift-outline" },
  ...
  "xmark.circle": { lib: "ion", name: "close-circle-outline" },
