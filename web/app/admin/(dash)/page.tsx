...
type Overview = {
  ...
  transactions: {
    ...
    pagaByStatus: Array<{ key: string; count: number }>;
    parked: number;
  };
  commerce: {
      ...
      {data ? (
        <div className="space-y-7">
          ...
          <StatGrid>
            ...
            <StatCard label="Cross-border transfers" value={fmtNum(data.transactions.transfers)} hint={`${data.transactions.paga} legacy Paga payouts`} />
          </StatGrid>
          ...
          <Card>
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              ...
              <BreakdownList title="paga_offramps.status" rows={data.transactions.pagaByStatus} />
            </div>
