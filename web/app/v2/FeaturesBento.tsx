...
const CARDS: Card[] = [
  ...
  { tag: "Earn", title: "Idle money grows.", body: "Sitting still? Talise quietly puts it to work, auto-routed, and always yours to move.", bg: "#C9B8FF", img: "/v2/sprout.webp", tilt: "1.2deg" },
  { tag: "Cash out", title: "Cash out at home.", body: "Turn dollars into your local currency, or wire USD to your bank. Enter an amount, withdraw.", bg: "#FFE59E", img: "/v2/phone.webp", tilt: "-1.2deg" },
];
