  ...
  return (
    <GlassCard className="space-y-4 p-6">
      ...
      <button
        type="button"
        onClick={copy}
        className="talise-glass flex w-full items-center justify-between gap-3 rounded-xl px-4 py-3.5 text-left transition-[border-color] hover:border-[color-mix(in_srgb,var(--color-accent-deep)_40%,var(--color-line))]"
      >
